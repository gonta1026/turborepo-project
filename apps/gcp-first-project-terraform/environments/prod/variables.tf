...
variable "api_domain_name" {
  description = "Custom domain name for the API service (e.g., prod.api.my-learn-iac-sample.site)"
  type        = string
  default     = ""
}
...
variable "dashboard_client_url" {
  description = "Dashboard client URL for CORS (e.g., https://prod.dashboard.my-learn-iac-sample.site)"
  type        = string
}